...
import 'package:toktik/config/helpers/format_values_number.dart';
...
class _CustomIconButton extends StatelessWidget {
  ...
  const _CustomIconButton({
    ...
    iconColor
  }): color = iconColor ?? Colors.white; // si no viene iconColor
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        if(value > 0)
          Text(FormatValuesNumbers.humanReadbleNumber(value.toDouble()))
      ]
    );
  }
}